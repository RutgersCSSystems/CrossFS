...
#c = pdf('figure1.pdf')
c = canvas('pdf', title='redis-set-multi', dimensions=[150, 90])
t = table(file='redis-set-multi.data')
...
#L.draw(c, coord=[d.left()-10, d.top()+10], width=4, height=4, fontsize=4, hspace=1, skipnext=1, skipspace=25)
