...
#c = pdf('figure1.pdf')
c = canvas('pdf', title='result_thread_fillrandom', dimensions=[150, 100])
t = table(file='thread_fillrandom.data')

d = drawable(canvas=c, coord=[25,22], xrange=[-0.5,t.getmax('rownumber')+0.5],
                yrange=[0,200], dimensions=[120, 60])
...
ytitle='Throughput(kops/s)', ytitlesize=6, ylabelfontsize=6, yauto=[0,200,100], ticmajorsize=2)

grid(drawable=d, x=False, yrange=[100,200], ystep=100, linecolor='lightgrey',
