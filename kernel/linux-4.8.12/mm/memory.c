...
/****************************************************************************/
/* XIP_HUGETLB support */
pte_t *pte_offset_pagesz(struct mm_struct *mm, unsigned long addr, unsigned long *sz)
{
	pgd_t *pgd;
	pud_t *pud;
	pmd_t *pmd = NULL;
...
pte_t *pte_alloc_pagesz(struct mm_struct *mm, unsigned long addr, unsigned long sz)
{
	pgd_t *pgd;
	pud_t *pud;
	pte_t *pte = NULL;
...
static void __unmap_xip_hugetlb_range(struct vm_area_struct *vma, unsigned long start, unsigned long end)
{
	struct mm_struct *mm = vma->vm_mm;
	unsigned long address;
	pte_t *ptep;
...
void unmap_xip_hugetlb_range(struct vm_area_struct *vma, unsigned long start, unsigned long end)
{
